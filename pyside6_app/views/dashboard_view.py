...
class DashboardView(QWidget):
    ...
    def init_ui(self):
        ...
        c1_sub = QLabel("↗ +6.2% compared to last 24h")
        ...
        c2_pbox = QHBoxLayout()
        c2_psub = QLabel("81% of total cameras")
        ...
        c3_sub = QLabel("Requires immediate attention")
        c3_sub.setStyleSheet("font-size: 10px; font-weight: 700; color: #EF4444;")
        ...
        c4_l.setSpacing(4)
        c4_top = QHBoxLayout()
        c4_lbl = QLabel("TOTAL DETECTIONS (24H)")
