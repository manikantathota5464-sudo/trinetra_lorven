...
export const SystemSettingsPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white border-2 border-[#E2E8F0] border-t-4 border-t-[#0A2540] rounded-2xl gov-card-interactive hover:shadow-lg transition-all duration-300 group overflow-hidden relative overflow-hidden shadow-sm flex flex-col">
          ...
          <form onSubmit={handleSaveChanges} className="p-6 space-y-6">
                  ...
                  <div className="flex flex-col gap-2 font-medium text-slate-700">
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        className="text-[#0A2540] focus:ring-[#0A2540]"
                      />
            ...
            <div className="space-y-4 pt-6 border-t border-slate-100">
              ...
              <div className="divide-y divide-slate-100 text-xs">
                ...
                {/* Change Password row */}
                <div className="flex justify-between items-center py-3.5 cursor-pointer hover:bg-slate-50 hover:border-[#0A2540] transition-colors duration-300 px-2 rounded-xl transition">
